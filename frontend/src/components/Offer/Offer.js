...
export default function Offer(props) {
    ...
    return (
        <div className="mt-4">
            <h1 className="text-center text-2xl">Discout Coupons</h1>
                        ...
                        <div className="terms col s12 m9 l8">
                            ...
                            <ul className="collection sm false" style={{ listStyle: 'number', margin: 'unset', flexFlow: 'column', placeContent: 'center flex-start', alignItems: 'flex-start' }}>
                                <li className="collection-item ">
                                    <div>Coupons are valid for registered users only, please register an account first if you don't have.</div>
                                </li>
                                <li className="collection-item ">
                                ...
                                <li className="collection-item ">
                                    <div>This coupon cannot be combined with any other coupon.</div>
                                </li>
                                <li className="collection-item ">
