      ...
      <div className="py-8 px-8 rounded-2xl shadow-xl z-20" style={{backgroundColor: "rgb(255 255 255 / 80%)"}}>
        ...
        >
          <div>
            ...
            <p className="text-center text-sm mb-8 font-semibold text-gray-700 tracking-wide">Sign in to continue to Southbound Travel</p>
          </div>
          <Form.Item
            label=""
            name="email"
          ...
          <div className="text-center">
            ...
            <div className="mt-2 text-sm">Don't have an account yet? <a href='register' className="underline  cursor-pointer"> Sign Up</a></div>
          </div>
        </Form>
      </div>
    </div>
