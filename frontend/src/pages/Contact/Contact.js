      ...
      <div className="header__img-text">
        <Form className="bg-white dark:bg-gray-900 absolute rounded-xl" style={{ left: '50%', top: '30%', transform: 'translate(-50%)' }} onSubmitCapture={formik.handleSubmit}>
          <div className="py-8 px-12 mx-auto max-w-screen-md text-left">
            ...
            <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">We’re always here to listen. Leave us a message!</p>
            <form className="space-y-8">
              ...
              <div>
                ...
                >
                  <Input required className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" onChange={formik.handleChange} placeholder="What do you need help with?" />
                </Form.Item>
              </div>
              <div className="sm:col-span-2">
                <label htmlFor="noiDung" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Content</label>
                <Form.Item
                  label=""
                  name="noiDung"
                  rules={[
