            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'National ID cannot be blank!',
                        },
                    ]}
                >
                    <Input name='nationalId' onChange={formik.handleChange} placeholder="National ID" />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Driver License cannot be blank!',
                        },
                    ]}
                >
                ...
                <Form.Item    label="Year Of Birth"
                            rules={[
                                {
                                    required: true,
                                    message: 'Year Of Birth cannot be blank!',
                                },
                            ]} >
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Place Of Birth cannot be blank!',
                        },
                    ]}
                >
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Enabled cannot be blank!',
                        },
                    ]}
                >
