      ...
      <div className="text-gray-600 body-font">
        <div className="container px-3 py-5 mx-auto">
          ...
          <div className="container">
            ...
            Cancellation 2+ days before the event: Full refund.
            Cancellation 1 day before the event: 15% of the total amount is deducted; the remaining amount is refunded.
            Cancellation on the event day: 30% of the total amount is deducted; the remaining amount is refunded.
            </p>
          </div>
          <div className='row w-full mx-auto mt-5'>
            <div className='col-6 px-5'>
              <div className='d-flex justify-between mt-3'>
                ...
                <h3 className='font-bold'>{ticketPrice?.toLocaleString("en-US", { style: "currency", currency: "PHP" })}</h3>
              </div>
              ...
              <div className='d-flex justify-between'>
                <p>Number of day before departure date</p>
                <h3>{remainDay}</h3>
              </div>
              <hr></hr>
              <div className='d-flex justify-between mt-3'>
                <p className="font-bold">You will get</p>
                <h3 className='text-xl font-bold text-red-600'>{refund.toLocaleString("en-US", { style: "currency", currency: "PHP" })}</h3>
              </div>
            </div>
